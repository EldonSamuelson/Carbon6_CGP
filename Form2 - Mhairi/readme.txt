...
Relative referencing is used, so there would be no need to change references anywhere. However, for edipredictformatting.html, you need a folder within public_html called CGS containing the photos then update the link in the html file to your studentID.
